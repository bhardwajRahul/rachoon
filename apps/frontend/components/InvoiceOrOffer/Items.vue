...
<template>
  ...
  <div class="flex justify-center mt-5 mb-10">
    <button
      ...
      @click="invoiceOrOffer.addPosition()"
    >
      <FaIcon icon="fa-add mr-5" />Add position
    </button>
  </div>
  <table
    class="table table-compact table-zebra w-full shadow-lg table-info"
    v-if="discountsCharges.length > 0"
  >
    <thead>
      <tr>
        <th width="20"></th>
        <th width="200" class="bg-primary primary bg-opacity-10">
          Discount/Charge
        </th>
        <th>Title</th>
  ...
  <p
    ...
    :class="invoiceOrOffer.disabled() ? 'opacity-30' : ''"
  >
