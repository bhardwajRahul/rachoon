...
<template>
  <FormSection
    title="Tax rates"
    description="Set the tax rates. Default is applied to all new positions"
  >
        ...
        <tr v-for="(r, i) in rates" :key="i">
          ...
          <td class="text-right">
            <button
              ...
              @click="useSettings().settings.removeTaxRate(i)"
            >
    ...
    <div class="flex justify-center mt-5">
      <button
        ...
        @click="useSettings().settings.addTaxRate()"
      >
  ...
  <FormSection
    title="Tax options"
    description="Tax options allow you to apply taxes to the final calculation, if applicable."
  >
    <table class="table table-compact table-zebra w-full m-0">
      <thead>
        <tr>
      ...
      <tbody>
        <tr v-for="(o, i) in options" :key="i">
          ...
          <td class="text-right">
            <button
              class="btn btn-square btn-sm mr-2"
              @click="useSettings().settings.removeTaxOption(i)"
            >
              <FaIcon icon="fa-trash-can" />
            </button>
          </td>
    ...
    <div class="flex justify-center mt-5">
      <button
        class="btn btn-xs btn-info btn-outline gap-1"
        @click="useSettings().settings.addTaxOption()"
      >
